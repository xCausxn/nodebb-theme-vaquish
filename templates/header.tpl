			...
			<div class="navbar-collapse collapse navbar-ex1-collapse">
				...
				<ul id="logged-in-menu" class="nav navbar-nav navbar-right hide">
					...
					<li class="notifications dropdown text-center hidden-xs">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#"><i class="fa fa-fw fa-bell-o" title="[[global:header.notifications]]"></i></a>
				...
				<ul id="logged-conditional-menu" class="nav navbar-nav navbar-right">
					<li>
						<form id="search-form" class="navbar-form navbar-right hidden-xs" role="search" method="GET" action="">
							...
							<button id="search-button" type="button" class="btn btn-link hide"><i class="fa fa-search" title="[[global:header.search]]"></i></button>
						</form>
					</li>
				</ul>
